...
export type VaxeeStoreOther<T> = UnwrapNestedRefs<Omit<T, VaxeeStoreStateNames<T> | VaxeeStoreGettersNames<T> | VaxeeStoreRequestsNames<T> | VaxeeStoreActionsNames<T>>>;
export {};
